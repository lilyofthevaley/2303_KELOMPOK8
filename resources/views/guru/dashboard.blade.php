                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                            Hadir Hari Ini</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            {{ \App\Models\Absensi::whereDate('tanggal', date('Y-m-d'))->where('status', 'hadir')->count() }}
                        </div>
                    </div>
                    <div class="col-auto">
...
<div class="row">
    <div class="col-md-6 mb-4">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <p>Kelola data siswa dan lihat informasi siswa.</p>
    ...
    <div class="col-md-6 mb-4">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <p>Konfirmasi absensi siswa dan export data absensi.</p>
                <a href="{{ route('guru.absensi.index') }}" class="btn btn-primary">
                    <i class="fas fa-arrow-right"></i> Kelola Absensi
                </a>
            </div>
        </div>
    </div>
